...
$query=mysqli_query($con,"update tblcategory set CategoryName='$catname' where id='$cid'"); 
...
<h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit Class</h4>
</div>
<!-- /Title -->
