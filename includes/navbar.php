<nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar"style=" 
...
<span style="color: white;"><?php echo $row['AdminName'];?><i class="zmdi zmdi-chevron-down"></i></span>
</div>
</div>
</a>
